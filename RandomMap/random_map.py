...
# Screen
screen = pygame.display.set_mode([GAME_WIDTH, GAME_HEIGHT], 0,
                                 32)  # Size,full_screen,colors #pygame.FULLSCREEN,32 needed?
...
coordinates = diamond_square(513)  # The size has to be 2^n+1
