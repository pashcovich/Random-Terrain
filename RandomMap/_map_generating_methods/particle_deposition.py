...
def ParticleDeposition(GAME_WIDTH, GAME_HEIGHT):
    ...
    for i in range(iterations):
        ...
        for coordinate in world_coordinates:
            ...
            if math.sqrt((random_coordinate[0] - coordinate[0]) ** 2 + (
                random_coordinate[1] - coordinate[1]) ** 2) <= radius_cannon:
        ...
        for drop_point in drop_points:
            ...
            for coordinate in world_coordinates:
                ...
                if (
                                ...
                                math.sqrt((drop_point[0] - coordinate[0]) ** 2 + (
                                    drop_point[1] - coordinate[1]) ** 2) <= stability_radius
                ):
